...
- [ ] Register `com.dihnatovich.didi`, `.widget`, and `.watchapp`
- [ ] Register and attach App Group `group.com.dihnatovich.didi` to app and widget IDs
...
- [ ] Resolve or explicitly accept Xcode's portrait-orientation archive warning before upload
