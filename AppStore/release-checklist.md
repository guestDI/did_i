...
- [x] Version `1.0` and build `1` are configured
...
- [ ] Upload `AppStore/build/Did I 1.0 (1).ipa` and wait for build processing
- [ ] If prompted for export compliance, answer that the app does not use encryption
- [ ] Create an internal testing group, add build `1`, and invite internal testers
- [ ] For external testing, create an external group and submit build `1` for Beta App Review
...
- [ ] Select build `1` for version `1.0`
