...
- [x] Version `1.0` and build `6` are configured
...
- [x] Upload `AppStore/build/Did I 1.0 (6).ipa`
- [ ] Wait for build `6` to finish processing
- [ ] If prompted for export compliance, answer that the app does not use encryption
- [ ] Create an internal testing group, add build `6`, and invite internal testers
- [ ] For external testing, create an external group and submit build `6` for Beta App Review
...
- [ ] Select build `6` for version `1.0`
