...
- Archive contents: app, widget extension, Watch app, privacy manifest, version `1.0`, build `4`, and `ITSAppUsesNonExemptEncryption = false`
...
`AppStore/build/Did I 1.0 (4).ipa`

The matching archive is at:

`/tmp/DidI-TestFlight-1.0-4-final-20260902.xcarchive`
