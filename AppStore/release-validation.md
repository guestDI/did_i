...
- Archive contents: app, widget extension, Watch app, privacy manifest, version `1.0`, build `6`, and `ITSAppUsesNonExemptEncryption = false`
...
- App Store Connect accepted build `6` on September 6, 2026; server-side TestFlight processing is pending
...
`AppStore/build/Did I 1.0 (6).ipa`

The matching archive is at:

`/tmp/DidI-TestFlight-1.0-6-final-20260906.xcarchive`
