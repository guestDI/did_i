...
- 5 end-to-end UI tests, including the App Store screenshot flow, confirmation clearing, and onboarding persistence
...
- Archive contents: app, widget extension, Watch app, privacy manifest, version `1.0`, build `8`, and `ITSAppUsesNonExemptEncryption = false`
...
- App Store Connect accepted build `8` on September 9, 2026; server-side TestFlight processing is pending. Build `7` was superseded before testing by the widget arrival-reset fix.
...
`AppStore/build/Did I 1.0 (8).ipa`

The matching archive is at:

`/tmp/DidI-TestFlight-1.0-8-20260909.xcarchive`
