...
3. Tap an item on the board to confirm it; tap again to undo if desired.
...
Notifications are optional and local-only. They are used for product guidance and
can be declined without limiting confirmation functionality.
