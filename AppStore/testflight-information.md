...
Did I? is a one-tap memory aid for everyday checks such as switching off the
stove, locking the door, or unplugging the iron. A confirmation records the time;
the app, widgets, and read-only Apple Watch companion show whether that record is
still current. There is no account, advertising, analytics, tracking, or developer
server. Location is optional and is used only on-device for the “When I come home”
expiry rule.

## Feedback and URLs

- Feedback email: `ignatovich.dm@gmail.com`
- Marketing URL: `https://guestdi.github.io/did_i/`
- Privacy policy URL: `https://guestdi.github.io/did_i/privacy/`
...
limiting the core confirmation flow.
